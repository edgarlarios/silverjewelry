...
<table width="908" border="0" align="center" cellpadding="0" cellspacing="0" id="principal">
  <tr>
    ...
    <td width="701" valign="top" class="CeldaPPAL">
        ...
        <form name="formularioProducto" method="POST" action="Compra" onsubmit="return validar_formulario()" >
        
        <fieldset>
            <legend>Compra de Producto</legend>
        <table>
            <tr>
            ...
            <tr>
                <td>Codigo postal</td><td><input type="text" name="codigo_postal"></td>
            </tr>
             <tr>
                <td>e-mail: </td><td><input type="text" name="correo"></td>
            </tr>
             <tr>
            ...
            <tr>
                <td>Nombre en tarjeta de credito: </td><td><input type="text" name="nom_tarjeta"></td>
            </tr>
            <tr>
                <td>Numero de tarjeta de credito: </td><td><input type="text" name="num_tarjeta_credito"></td>
            </tr>
            <tr>
                <td>Codigo CVV: </td><td><input type="text" name="cogigo"></td>
            </tr>
            <tr>
                <td>Expira en: </td><td><input type="text" name="expira" value="mm-aaaa"></td>
            </tr>
            <td></td><td><button type="submit" formmethod="post"  name="enviar"  >Comprar</button></td>
            </tr>
            </form>
        </table>
        </fieldset>
