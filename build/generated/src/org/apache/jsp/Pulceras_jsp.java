...
public final class Pulceras_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    //rs.next();
     //rs = stm.executeQuery("select * from productos ");
      ...
      out.write("     ");
            ...
            out.print("<bloquote>");
            out.print("<tr><td>"+ rs.getString("nombre")+" </td></tr>");
            out.print("<tr><td><img width='100' height='80' src="+ rs.getString("imagen")+"> </td><td><td> "+ rs.getString("descripcion")+"  </td></tr>");
            out.print("<tr><td >Cantidad disponible:"+ rs.getString("cantidad")+"</td><td>Precio:"+ rs.getString("precio")+" </td></tr>");
            out.print("</bloquote>");
            }  
            out.print("</table>");      
