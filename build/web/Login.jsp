...
<script>
            ...
            function validar_login(){
                if(document.LoginUsuario.correo1.value.length == ''){
                    alert("Debe ingresar el ID");
                    document.LoginUsuario.correo1.focus();
                    return false;
                }
                if(document.LoginUsuario.password1.value.length == ''){
                    alert("Debe ingresar el password");
                    document.LoginUsuario.password1.focus();
                    return false;
                }
               ...
               // document.LoginUsuario.action="Usuarios/AplicarExamenn.jsp";
                document.LoginUsuario.submit(); 
                //ventanaPreguntas();  action="Usuarios/AplicarExamenn.jsp"               
            }          
        </script>
...
<table width="908" border="0" align="center" cellpadding="0" cellspacing="0" id="principal">
  <tr>
    ...
    <td width="701" valign="top" class="CeldaPPAL">
        &nbsp;
        &nbsp;
        <form name="LoginUsuario" method="POST" action="validarSesion" onsubmit="return validar_login()" >   
         <fieldset>
            <legend>Login</legend>
            <table>
            <tr>
                <td>Correo: </td><td><input type="text" name="correo1"></td>
            </tr>
            <tr>
                <td>Password: </td><td><input type="password" name="password1"></td>
            </tr>
            <br>
            <td><a href="Registro.jsp">Registrarse</a></td><td><button type="submit" formmethod="POST"  name="acceso"  >Entrar</button></td>
            </tr>
            </form>
        </table>
        </fieldset>
